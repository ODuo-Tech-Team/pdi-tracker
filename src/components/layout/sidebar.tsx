...
const intranetItems = [
  { href: '/dashboard/comunicados', label: 'Comunicados', icon: Newspaper },
  { href: '/dashboard/calendario', label: 'Calendário', icon: Calendar },
  { href: '/dashboard/diretorio', label: 'Diretório', icon: Users2 },
  { href: '/dashboard/conhecimento', label: 'Conhecimento', icon: BookOpen },
]

const managerItems = [
  { href: '/dashboard/equipe', label: 'Minha Equipe', icon: Users },
  { href: '/dashboard/okrs/validacao', label: 'Validar OKRs', icon: CheckSquare },
